...
![CRD Layout](layweb.webp){fig-align="center"}
...
If the assumptions of ANOVA are slightly violated, or if there are unequal sample sizes (missing values) in the dataset, the F-statistic can be adjusted using **Aitken's adjustment** or a **corrected mean square** approach using the @eq-ct:
