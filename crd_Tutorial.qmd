...
/* Only center this specific title */
.layout-title {
  text-align: center;
  color: #333;
  margin-top: 20px;
...
# Title for layout (use class to control its alignment)
cat('<h2 class="layout-title">Randomized CRD Layout</h2>\n')
...
for (i in 1:nrow(layout)) {
  for (j in 1:ncol(layout)) {
    trt <- layout[i, j]
    class_name <- paste0("cell treatment-", tolower(trt))
    cat(sprintf('<div class="%s">%s</div>\n', class_name, trt))
  }
}
...
::: {.formula-card onmouseover="this.style.transform='scale(1.05)'; this.style.boxShadow='0 8px 20px rgba(0,0,0,0.3)'" onmouseout="this.style.transform='scale(1)'; this.style.boxShadow='0 4px 10px rgba(0,0,0,0.2)'"}
<h2 style="color:#00695c; text-align:center;">
...
<p style="text-align:center; font-size:0.9rem; color:#00796b;">
...
<img id="mango" src="mangodata.webp" style="display:none; margin-top:10px; max-width:100%;">
...
<img id="chem-img" src="CHEMEXAMPLE.webp" style="display:none; max-width:100%; margin-top:10px;">
...
<a href="#" onclick="var img=document.getElementById('shape-img'); img.style.display = img.style.display === 'none' ? 'block' : 'none'; return false;">Example3</a>
<img id="shape-img" src="SHAPEEXAMPLE.webp" style="display:none; max-width:100%; margin-top:10px;">
...
![Analysis Window in RAISINS](Results table .webp){fig-align="center"}
...
<div class="gallery-row">
  <img src="Cust1.webp" onclick="openModal(this)">
  <img src="Cust2.webp" onclick="openModal(this)">
  <img src="Cust3.webp" onclick="openModal(this)">
  <img src="Cust4.webp" onclick="openModal(this)">
  <img src="Cust5.webp" onclick="openModal(this)">
  <img src="Cust6.webp" onclick="openModal(this)">
  <img src="Cust8.webp" onclick="openModal(this)">
  <img src="Cust9.webp" onclick="openModal(this)">
  <img src="Cust10.webp" onclick="openModal(this)">
</div>
...
![Multivariate tab in RAISINS](MULTITAB.webp){fig-align="center"} 
...
![](MAN7.webp){fig-align="center"} 
![](MAN8.webp){fig-align="center"} 
