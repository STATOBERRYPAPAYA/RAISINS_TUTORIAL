...
<ul>
  <li>
    <span data-bs-toggle="tooltip" data-bs-placement="right" 
          title="Treatments are randomly assigned to experimental units to eliminate bias.">
      🎲 <b>Random allocation</b>
    </span>
  </li>

  <li>
    <span data-bs-toggle="tooltip" data-bs-placement="right" 
          title="Best suited when experimental units are relatively uniform">
      🌿 <b>Homogeneous conditions</b>
    </span>
  </li>

  <li>
    <span data-bs-toggle="tooltip" data-bs-placement="right" 
          title="The number of replications can vary between treatments, offering flexibility in design.">
      🔄 <b>Flexibility</b>
    </span>
  </li>
  ...
  <li>
    <span data-bs-toggle="tooltip" data-bs-placement="right" 
          title="Uses one-way ANOVA for statistical analysis.">
      📊 <b>Simple analysis</b>
    </span>
  </li>
</ul>
...
<div class="formula-card" onmouseover="this.style.transform='scale(1.05)'; this.style.boxShadow='0 8px 20px rgba(0,0,0,0.3)'" 
     onmouseout="this.style.transform='scale(1)'; this.style.boxShadow='0 4px 10px rgba(0,0,0,0.2)'">
  
  <h2 style="color:#00695c; text-align:center;">CRD Linear Model</h2>
  ...
  <p style="text-align:center; font-size:0.9rem; color:#00796b;">Hover over this card to see it pop!</p>
</div>
...
We'll walk you through every stage of the **Completely Randomised Design** step by step. Let's start by examining how the analysis can be performed using **Example 1**, which is covered in **Section** . For clarity, here’s a quick recap of the example: Ten mango cultivars each representing a different treatment, are being evaluated by a horticultural scientist. Alphonso, Kesar, Dasheri, Himsagar, Chausa, Badami, Safeda, Bombay, Langra, and Totapuri are among the kinds that are included. Thirty observations are obtained by replicating each variety three times.
...
::: {.g-col-6}
![BOX PLOT](CRDBOXPLOT.webp){fig-align="center"} 
:::

::: {.g-col-6}  

A boxplot—also called a box-and-whisker plot—is a graphical representation used in statistics to display the distribution of a dataset based on its five-number summary: minimum, first quartile (Q1), median (Q2), third quartile (Q3), and maximum.
...
::: {.grid}
::: {.g-col-6}
![VIOLIN PLOT](CRDVIOLINPLOT.webp){fig-align="center"} 
:::
::: {.g-col-6 .d-flex .align-items-center}  
::: {.px-3}
A boxplot—also called a box-and-whisker plot—is a graphical representation used in statistics to display the distribution of a dataset based on its five-number summary: minimum, first quartile (Q1), median (Q2), third quartile (Q3), and maximum.
...
::: {.grid}
::: {.g-col-6}
![Mean Value Plot](CRDMEANVPLOT.webp){fig-align="center"} 
:::
::: {.g-col-6 .d-flex .align-items-center}  
::: {.px-3}
A boxplot—also called a box-and-whisker plot—is a graphical representation used in statistics to display the distribution of a dataset based on its five-number summary: minimum, first quartile (Q1), median (Q2), third quartile (Q3), and maximum.
...
::: {.grid}
::: {.g-col-6}
![Connected Line Plot](CRDCONNECT.webp){fig-align="center"} 
:::
::: {.g-col-6 .d-flex .align-items-center}  
::: {.px-3}
A boxplot—also called a box-and-whisker plot—is a graphical representation used in statistics to display the distribution of a dataset based on its five-number summary: minimum, first quartile (Q1), median (Q2), third quartile (Q3), and maximum.
...
::: {.grid}
::: {.g-col-6}
![Bar Plot with grouping](CRDBARPLOT.webp){fig-align="center"} 
:::
::: {.g-col-6 .d-flex .align-items-center}  
::: {.px-3}
A boxplot—also called a box-and-whisker plot—is a graphical representation used in statistics to display the distribution of a dataset based on its five-number summary: minimum, first quartile (Q1), median (Q2), third quartile (Q3), and maximum.
