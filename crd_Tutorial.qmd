...
<img src="mangodata.webp" alt="Completely Randomised Design Example1" style="max-width: 50%; height: auto;"/>
:::
...
<img src="CHEMEXAMPLE.webp" alt="Completely Randomised Design Example2" style="max-width: 50%; height: auto;"/>
:::
...
<img src="SHAPEEXAMPLE.webp" alt="Completely Randomised Design Example3" style="max-width: 50%; height: auto;"/>
:::
...
![Dataset arrangement for analyzing Ten mango cultivars each representing a different treatment evaluated by a horticultural scientist using the Completely Randomised Design in RAISINS](mangodata.webp){#fig-data}
...
![Result table in RAISINS](res1.webp){#fig-res1 fig-align="center" width="55%"}
