...
Plots and visualizations serve as a critical bridge between raw data and actionable insights by transforming complex, often abstract analytical outputs into clear, intuitive, and engaging representationsThese plots are highly customizable to enhance clarity and aesthetics. You can adjust colors, line styles, marker shapes, fonts, and sizes, add labels, titles, legends, or grid lines, and modify scales or orientations
...
<div class="grid-item" onclick="openModal('images/kwt/plot2.png', 'TITLES & LABELS: Once clicked a dropdown menu appears, where you can change the axis title, plot titles and legends. You can enter them manually !')">
  ...
  <div class="grid-item" onclick="openModal('images/kwt/plot3.png', 'COLORS AND PATTERNS: This section is used to change the colours of the each plots. Different themes are available in this section. Use them accordingly.')">
    <img src="images/kwt/plot3.png" alt="Plot 3">
  </div>
  <div class="grid-item" onclick="openModal('images/kwt/plot4.png', 'SHOW/HIDE OPTIONS: This section enables to toggle whether you wish to display the axis labels and grouping letters.Their respective colors can also be changed.')">
    <img src="images/kwt/plot4.png" alt="Plot 4">
  </div>
  <div class="grid-item" onclick="openModal('images/kwt/plot5.png', 'LINE & THEME: The appearance of lines can be changed in this part.')">
    <img src="images/kwt/plot5.png" alt="Plot 5">
  </div>
  <div class="grid-item" onclick="openModal('images/kwt/plot6.png', 'LINE & THEME: Along with changing the line type, the respective theme of visualization can also be changed.')">
    <img src="images/kwt/plot6.png" alt="Plot 6">
  </div>
  <div class="grid-item" onclick="openModal('images/kwt/plot7.png', 'SIZE & SPACING:  The distance of each section and their size can be changed here.')">
    <img src="images/kwt/plot7.png" alt="Plot 7">
  </div>
  <div class="grid-item" onclick="openModal('images/kwt/plot8.png', 'TEXT & LABEL:  Here you can change text color and size, also the background color !.')">
